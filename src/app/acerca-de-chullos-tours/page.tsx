...
const TIMELINE = [
  { year: '2020', title: 'Fundación', desc: 'Nace Chullos Tours con la misión de ofrecer experiencias auténticas en Perú, destacando su rica cultura, historia y paisajes. Desde el inicio, la empresa se enfocó en brindar servicios personalizados y de alta calidad.', image: '/media/tours/city-tour-cusco/05.avif' },
  { year: '2020', title: 'Adaptación', desc: 'La pandemia global trajo grandes retos. Implementamos estrictos protocolos de bioseguridad y mantuvimos la conexión con nuestros viajeros promoviendo la planificación de futuros viajes a través de contenido virtual.', image: '/media/tours/laguna-humantay-tour-cusco/05.avif' },
  ...
  { year: '2023', title: 'Innovación', desc: 'Un año de innovación tecnológica. Lanzamos una nueva plataforma web para facilitar reservas y adoptamos herramientas digitales para mejorar la gestión y comunicación con nuestros clientes.', image: '/media/tours/montana-colores-vinicunca-tour/06.avif' },
  { year: '2023', title: 'Crecimiento', desc: 'Expandimos nuestros servicios hacia destinos como Puno y Arequipa. Formamos alianzas estratégicas locales y diversificamos nuestros paquetes para familias, grupos y aventureros.', image: '/media/tours/tour-machu-picchu-2-dias/01.jpg' },
  { year: '2024', title: 'Reconocimiento', desc: 'Atrajimos a más viajeros internacionales mediante una sólida estrategia digital y presencia en ferias de turismo, consolidando nuestra reputación como una agencia altamente confiable.', image: '/media/tours/valle-sagrado-vip-tour-cusco/05.avif' },
